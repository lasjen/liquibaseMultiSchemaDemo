...
@Slf4j
public class MultiSchemaLiquibase extends MultiTenantSpringLiquibase {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MultiSchemaLiquibase.class);
    private ResourceLoader resourceLoader;

    @Autowired
    OracleConfiguration oracleConfiguration;

    public MultiSchemaLiquibase() {
        super();
    }
    ...
    private void runOnAllSchemasXm() throws LiquibaseException {
        log.info("DEBUG: Entering runOnALlSchemasXm");
